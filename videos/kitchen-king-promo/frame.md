...
description: >
  ...
  the three-face stack (Shrikhand display tilted at poster scale, -apple-system serif body,
...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "-apple-system", cqw: 0.85, weight: 400, lineHeight: 1.75, color: "dark" }
  body-cell:{ fontFamily: "-apple-system", cqw: 0.7, weight: 400, lineHeight: 1.55 }
...
- **Fonts** — already set to **-apple-system** (display) / **Work Sans** (body); ignore any preset font name lingering in prose.
...
- **-apple-system serif body** (line 1.75); **Space Grotesk** chrome (uppercase tracked).
...
- **Shrikhand + -apple-system + Space Grotesk via Google Fonts.** CJK: Noto Serif SC 900/400 + Noto Sans SC; Shrikhand's slab-script has no Hanzi equal — keep tilts + red + double-borders to carry the identity.
